...
if st.session_state.step == 1:
    ...
    st.session_state.g_age = st.slider("Groom Age ", 18.0, 100.0, st.session_state.g_age, 1)
    ...
    st.session_state.b_age = st.slider("Bride Age ", 18.0, 100.0, st.session_state.b_age, 1)
    st.write("<br>", unsafe_allow_html=True)
