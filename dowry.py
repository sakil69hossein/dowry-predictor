...
if st.session_state.step == 1:
    ...
    st.session_state.g_inc = st.slider("Groom Age ", 0.0, 100.0, st.session_state.g_inc, 0.5)
    ...
    st.session_state.b_inc = st.slider("Bride Age ", 0.0, 100.0, st.session_state.b_inc, 0.5)
    st.write("<br>", unsafe_allow_html=True)
